...
def test_cardinality_both_star() -> None:
    ...
    assert cardinality.lower_bound == "*" and cardinality.upper_bound == "*"
...
def test_cardinality_lower_value_upper_star() -> None:
    ...
    assert cardinality.lower_bound == "1" and cardinality.upper_bound == "*"
...
def test_cardinality_lower_lower_than_upper() -> None:
    ...
    assert cardinality.lower_bound == "1" and cardinality.upper_bound == "2"
