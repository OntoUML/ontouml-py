...
from vocabulary_lib.classes.ouelement_types import OUCardinality
from vocabulary_lib.functions.func_mappings import get_outerm_from_ouelement, get_ouelement_from_outerm
